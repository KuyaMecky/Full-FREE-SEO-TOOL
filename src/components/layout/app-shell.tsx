...
const NAV: Array<{ label?: string; items: NavItem[] }> = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/content-gap",    label: "Content Gaps",   icon: Target },
      ...
      { href: "/backlink-trends",  label: "Backlink Trends",  icon: TrendingUp },
      { href: "/link-quality",     label: "Link Quality",     icon: ShieldCheck },
