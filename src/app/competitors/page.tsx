...
export default function CompetitorsPage() {
  ...
  const run = async () => {
    if (!yourDomain.trim()) {
      setError("Your domain is required");
      return;
    }
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="yourDomain">Your domain</Label>
              <Input
                id="yourDomain"
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>
                {report.gapAnalysis.themesCompetitorsCoverYouDont.length ===
                0 ? (
            ...
            <Card>
              ...
              <CardContent>
                {report.gapAnalysis.themesYouCoverCompetitorsDont.length ===
                0 ? (
